...
%根据纸张的宽度设置margin
\ifthenelse{
    \lengthtest { \paperwidth = 11in}}
	   { \geometry{top=.5in,left=.5in,right=.5in,bottom=.5in} }
{\ifthenelse{ 
    \lengthtest{ \paperwidth = 297mm}}
...
\begin{center}
     \Large{Bash Reference Card} \\
\end{center}

\section{相关文件}
\begin{tabular}{@{}ll@{}}
.bashrc          & Default is two-sided. \\
.bash\_profile   & divisions. \\
.bash\_history   & divisions. \\
\end{tabular}
...
Copyright \copyright\ 2011 Jintian Deng
